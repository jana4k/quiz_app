...
class _loginPageState extends State<loginPage> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    CircleAvatar(
                      radius: 50,
                      backgroundImage: const AssetImage('assets/images/file.jpg'), // Add your logo image in the assets folder
  ...
  void _login() {
    LoadingDialog.show(context);
       AuthService().loginWithEmailAndPassword(email: _emailController.text, password: _passwordController.text).then((status){
